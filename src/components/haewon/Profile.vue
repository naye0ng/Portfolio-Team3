  ...
  <v-layout row justify-center wrap>
    ...
    <v-flex xs12 justify-center text-xs-center>
      <div class="mt-4">
        ...
        <v-layout align-center justify-center row mt-3 v-if="isemail">
          <v-flex xs2 text-xs-center ml-1 mr-1>
            <v-btn color="#df4a31" outline v-on:click="linkwithSNS(1)" style="width:100%;">
              <v-icon size="25" class="mr-2">fa-google</v-icon>Google 연동
            </v-btn>
          </v-flex>
          <v-flex xs2 text-xs-center ml-1 mr-1>
            <v-btn color="#3C5A99" outline v-on:click="linkwithSNS(2)" style="width:100%;">
              <v-icon size="25" class="mr-2">fa-facebook</v-icon>Facebook 연동
            </v-btn>
          </v-flex>
          <v-flex xs2 text-xs-center ml-1 mr-1>
            <v-btn color="#181818" outline v-on:click="linkwithSNS(3)" style="width:100%;">
